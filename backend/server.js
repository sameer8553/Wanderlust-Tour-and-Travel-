    ...
    function getMatchingDestinations(query) {
        const allDestinations = [
            ...
            { name: "Phuket, Thailand", price: 1099, rating: 4.3, category: "beach" },
            { name: "Bali, Indonesia", price: 899, rating: 4.5, category: "beach" },
            { name: "Santorini, Greece", price: 1499, rating: 4.2, category: "beach" },
            { name: "Paris, France", price: 1199, rating: 4.9, category: "city" },
            { name: "New York, USA", price: 1499, rating: 4.7, category: "city" },
            { name: "London, UK", price: 1299, rating: 4.6, category: "city" },
            { name: "Tokyo, Japan", price: 1399, rating: 4.8, category: "city" },
            { name: "Swiss Alps, Switzerland", price: 1599, rating: 4.7, category: "mountain" },
            { name: "Himalayas, Nepal", price: 1699, rating: 4.8, category: "mountain" },
            { name: "Mount Fuji, Japan", price: 1599, rating: 4.7, category: "mountain" },
            { name: "Rocky Mountains, USA", price: 1499, rating: 4.6, category: "mountain" }
        ];
